html = """
    ...
    <title>Password Reset of Chotuve Account</title>
            ...
            <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                        ...
                        <tr>
                            <td align="center" bgcolor="#65ce2a" style="border-radius: 6px;">
                            <span style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 20px; font-weight: bold; color: #ffffff; text-decoration: none; border-radius: 6px;">{}</span>
                        </table>
                    </td>
                    </tr>
                </table>
